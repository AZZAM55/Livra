...
<script type="application/javascript">
	...
	function act(op){
		$.ajax({
			...
			beforeSend:function(){ window.$('#msg').html('<img src="../Public/Alizi/loading.gif">'); },
...
<div class="dupl">
	<div class="alert"><span id="msg">订单确认（确认后优先发货）</span></div>
	<div>
		<span class="btn btn-red fileinput-button" onclick="act(2)"><span>确认订单</span></span>
    	<span class="btn btn-grey fileinput-button" onclick="act(6)"><span>取消订单</span></span>
	</div>
</div>
</body>
</html>