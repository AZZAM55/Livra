...
<?php if(!empty($info["timer"])): ?><script type="text/javascript"> seajs.use(['alizi'],function(alizi) {  alizi.timer('#alizi-timer', '<?php echo ($info["timer"]); ?>'); })</script>
<?php else: ?>
<script type="text/javascript">seajs.use(['jquery'],function($) {  $('#alizi-timer').html(''); })</script><?php endif; ?>
