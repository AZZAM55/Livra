...
class AlipaySubmit {
	...
	function buildRequestForm($para_temp, $method, $show_message) {
		...
		$sHtml .= "<form id='alipaysubmit' enctype='multipart/form-data;charset=utf-8' name='alipaysubmit' action='".$this->alipay_gateway_new."_input_charset=".trim(strtolower($this->alipay_config['input_charset']))."' method='".$method."'>";
