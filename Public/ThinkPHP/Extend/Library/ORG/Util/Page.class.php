...
class Page {
	...
	protected $config  =    array('header'=>'条记录','prev'=>'<','next'=>'>','first'=>'<<','last'=>'>>','theme'=>'<strong class="alizi-pager"> %totalRow% %header% %nowPage%/%totalPage% 页</strong> %first% %upPage%  %prePage%  %linkPage%  %nextPage% %downPage% %end%');
    // 默认分页变量名
    protected $varPage;
