...
class ItemModel extends Model {
	...
	protected $fields = 'id,sn,category_id,name,original_price,price,image,thumb,is_hot,brief,timer,salenum';

	public function _initialize($aliziConfig=array()){
 		parent::_initialize();
	...
	public function hotList(){
    		...
    		$where = "is_delete=0 AND status=1 AND is_hot=1 AND image!=''";
